...
# myephoto.exe is for A-Ci optimization
myCppCompiler -o myephoto.exe -I$sundial_path -I$ephoto_path/include -I$ephoto_path/build run_ephoto_EPS.cpp -L$ephoto_path/build -lEPhotosynthesis -Wl,-rpath,$ephoto_path/build 
